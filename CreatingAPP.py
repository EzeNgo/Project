...
model = joblib.load('HA_regression_model.pkl')

#Ttile and discription
...
weight=st.number_input('Weight(kg)', min_value= 10, max_value=300, value=200, step=1)
